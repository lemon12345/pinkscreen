      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-pink-600 via-rose-600 to-pink-700 bg-clip-text text-transparent mb-4">
              {t("info.title")}
            </h2>
          ...
          <motion.div 
            ...
            className="bg-gradient-to-r from-white to-pink-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-8 shadow-xl border border-pink-100 dark:border-pink-800/50 backdrop-blur-sm mb-16"
          >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                <div className="bg-pink-50 dark:bg-gray-900/20 rounded-xl p-6 mb-6 border border-pink-200 dark:border-gray-700 group-hover:shadow-lg transition-all duration-300">
              ...
              >
                <div className="bg-pink-50 dark:bg-gray-900/20 rounded-xl p-6 mb-6 border border-pink-200 dark:border-gray-700 group-hover:shadow-lg transition-all duration-300">
                  ...
                  <motion.button 
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="bg-gradient-to-r from-rose-500 to-pink-600 hover:from-rose-600 hover:to-pink-700 text-white px-8 py-3 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl flex items-center gap-2 mx-auto"
                  >
                    <Download className="w-5 h-5" />
                    {t("info.fourKButton")}
                  </motion.button>
