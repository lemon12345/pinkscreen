...
const COLORS_BACKGROUND = ["#0000FF", "#1E90FF", "#4169E1", "#6495ED"];

export default function BlueScreenHero({
  selectedColor,
  onColorChange,
  onFullscreen,
  onDownload,
  ...
  const backgroundImage = useMotionTemplate`radial-gradient(125% 125% at 50% 0%, #eff6ff 0%, #dbeafe 50%, #bfdbfe 100%)`;
  ...
  return (
    <motion.section
      className="relative grid place-content-center overflow-hidden py-16 md:py-28 2xl:py-40 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950"
    >
      {/* Background decorative elements */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-20 w-32 h-32 bg-blue-400/30 dark:bg-blue-300/40 rounded-full blur-3xl animate-pulse" />
        <div className="absolute top-40 right-20 w-40 h-40 bg-purple-400/30 dark:bg-purple-300/40 rounded-full blur-3xl animate-bounce" />
        <div className="absolute bottom-20 left-1/3 w-28 h-28 bg-pink-400/30 dark:bg-pink-300/40 rounded-full blur-2xl animate-pulse delay-1000" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center px-4">
        ...
        >
          <motion.span
            className="inline-flex items-center gap-2 rounded-full bg-blue-600/50 dark:bg-blue-400/30 px-3 py-1.5 text-sm text-blue-100 dark:text-blue-50"
          ...
          >
            ...
            <div className="grid grid-cols-5 gap-3">
              {colors.map((colorOption) => (
                colorOption.href && colorOption.href !== "/blue-screen" ? (
                  <I18nLink
