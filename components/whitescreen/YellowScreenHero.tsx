...
interface YellowScreenHeroProps {
...
const COLORS_BACKGROUND = ["#FFFF00", "#FFEB3B", "#FFC107", "#FF9800"];

export default function YellowScreenHero({
  selectedColor,
  onColorChange,
  onFullscreen,
  onDownload,
  onCustomColorChange,
}: YellowScreenHeroProps) {
  ...
  const backgroundImage = useMotionTemplate`radial-gradient(125% 125% at 50% 0%, #fefce8 0%, #fef3c7 50%, #fde68a 100%)`;
          ...
          >
            ...
            <div className="grid grid-cols-5 gap-3">
              {colors.map((colorOption) => (
                colorOption.href && colorOption.href !== "/yellow-screen" ? (
                  <I18nLink
