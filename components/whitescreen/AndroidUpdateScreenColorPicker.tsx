...
interface AndroidUpdateScreenColorPickerProps {
...
export default function AndroidUpdateScreenColorPicker({
  selectedColor,
  colors,
  onColorChange,
  onCustomColorChange,
  ...
  onStartTimeChange,
  onRestart,
}: AndroidUpdateScreenColorPickerProps) {
