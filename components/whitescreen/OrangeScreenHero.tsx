...
interface OrangeScreenHeroProps {
...
const COLORS_BACKGROUND = ["#FFA500", "#FF8C00", "#FF7F50", "#FF6347"];

export default function OrangeScreenHero({
  selectedColor,
  onColorChange,
  onFullscreen,
  onDownload,
  onCustomColorChange,
}: OrangeScreenHeroProps) {
  ...
  return (
    <motion.section
      className="relative grid place-content-center overflow-hidden py-16 md:py-28 2xl:py-40 bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950"
    >
      {/* Background decorative elements */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-20 w-32 h-32 bg-orange-400/30 dark:bg-orange-300/40 rounded-full blur-3xl animate-pulse" />
        <div className="absolute top-40 right-20 w-40 h-40 bg-red-400/30 dark:bg-red-300/40 rounded-full blur-3xl animate-bounce" />
      ...
      <div className="relative z-10 flex flex-col items-center px-4">
        ...
        >
          <motion.span
            className="inline-flex items-center gap-2 rounded-full bg-orange-600/50 dark:bg-orange-400/30 px-3 py-1.5 text-sm text-orange-100 dark:text-orange-50"
          ...
          >
            ...
            <div className="grid grid-cols-5 gap-3">
              {colors.map((colorOption) => (
                colorOption.href && colorOption.href !== "/orange-screen" ? (
                  <I18nLink
