...
interface BlackScreenHeroProps {
...
export default function BlackScreenHero({
  selectedColor,
  onColorChange,
  onFullscreen,
  onDownload,
  onCustomColorChange,
}: BlackScreenHeroProps) {
  ...
  const backgroundImage = useMotionTemplate`radial-gradient(125% 125% at 50% 0%, #1f2937 0%, #374151 50%, #4b5563 100%)`;
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-20 w-32 h-32 bg-gray-400/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute top-40 right-20 w-40 h-40 bg-purple-400/20 rounded-full blur-3xl animate-bounce" />
        <div className="absolute bottom-20 left-1/3 w-28 h-28 bg-blue-400/20 rounded-full blur-2xl animate-pulse delay-1000" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center px-4">
        ...
        >
          <motion.span
            className="inline-flex items-center gap-2 rounded-full bg-gray-600/50 px-3 py-1.5 text-sm text-white font-medium"
        ...
        <motion.h1
          ...
          className="max-w-4xl bg-gradient-to-r from-white via-blue-100 to-purple-100 bg-clip-text text-center text-3xl font-bold leading-tight text-transparent sm:text-5xl sm:leading-tight md:text-7xl md:leading-tight drop-shadow-lg"
        >
          {t("hero.title")}
        </motion.h1>
        ...
        <motion.p
          ...
          className="mt-6 mb-12 max-w-3xl text-center text-base leading-relaxed md:text-lg md:leading-relaxed text-white font-medium drop-shadow-md"
        >
          {t("hero.description")}
        </motion.p>
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-semibold text-white">{t("interface.livePreview")}</h3>
            </div>
            ...
            <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
              ...
              >
                <div className="flex items-center gap-2 bg-black/20 text-white px-4 py-2 rounded-full backdrop-blur-sm">
                  ...
                  <span className="text-sm font-medium">{t("interface.clickForFullscreen")}</span>
                </div>
              </div>
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-semibold text-white">{t("interface.chooseYourColor")}</h3>
            </div>

            <div className="grid grid-cols-5 gap-3">
              {colors.map((colorOption) => (
                colorOption.href && colorOption.href !== "/black-screen" ? (
                  <I18nLink
