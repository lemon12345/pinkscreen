...
interface GreenScreenHeroProps {
...
const COLORS_BACKGROUND = ["#00FF00", "#32CD32", "#228B22", "#006400"];

export default function GreenScreenHero({
  selectedColor,
  onColorChange,
  onFullscreen,
  onDownload,
  onCustomColorChange,
}: GreenScreenHeroProps) {
  ...
  const backgroundImage = useMotionTemplate`radial-gradient(125% 125% at 50% 0%, #f0fdf4 0%, #dcfce7 50%, #bbf7d0 100%)`;
  ...
  return (
    <motion.section
      className="relative grid place-content-center overflow-hidden py-16 md:py-28 2xl:py-40 bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950"
    >
      {/* Background decorative elements */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-20 w-32 h-32 bg-green-400/30 dark:bg-green-300/40 rounded-full blur-3xl animate-pulse" />
        <div className="absolute top-40 right-20 w-40 h-40 bg-blue-400/30 dark:bg-blue-300/40 rounded-full blur-3xl animate-bounce" />
        <div className="absolute bottom-20 left-1/3 w-28 h-28 bg-yellow-400/30 dark:bg-yellow-300/40 rounded-full blur-2xl animate-pulse delay-1000" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center px-4">
        ...
        >
          <motion.span
            className="inline-flex items-center gap-2 rounded-full bg-green-600/50 dark:bg-green-400/30 px-3 py-1.5 text-sm text-green-100 dark:text-green-50"
          ...
          >
            ...
            <div className="grid grid-cols-5 gap-3">
              {colors.map((colorOption) => (
                colorOption.href && colorOption.href !== "/green-screen" ? (
                  <I18nLink
