...
interface MacOSXUpdateScreenHeroProps {
...
export default function MacOSXUpdateScreenHero({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-40 right-20 w-40 h-40 bg-gray-400/3 rounded-full blur-3xl animate-bounce" />
        <div className="absolute bottom-20 left-1/3 w-28 h-28 bg-white/8 rounded-full blur-2xl animate-pulse delay-1000" />

        {/* 苹果线条装饰 */}
        <div className="absolute top-32 left-0 w-full h-px bg-white/10" />
        <div className="absolute bottom-32 left-0 w-full h-px bg-white/10" />
        <div className="absolute left-20 top-0 w-px h-full bg-white/8" />
        <div className="absolute right-20 top-0 w-px h-full bg-white/8" />
        ...
        <div className="absolute inset-0 pointer-events-none">
          {[
            ...
            <div
              key={i}
              className="absolute text-white/5 text-lg animate-pulse"
              style={{
                left: `${item.left}%`,
                top: `${item.top}%`,
        ...
        >
          ...
          >
            ...
            <div className={`relative bg-gray-100 shadow-lg overflow-hidden ${isFullscreen ? 'rounded-none border-none' : 'rounded-lg border border-gray-200'}`}>
              {/* 完全复刻 MacOSXUpdateScreenPreview.tsx 的预览区域 */}
              <div
                ref={previewRef}
                className={`w-full h-64 cursor-pointer hover:opacity-90 transition-opacity full-screen ${isFullscreen ? 'rounded-none border-none' : 'rounded-lg border border-gray-600'}`}
                style={{
                  backgroundColor: "#000",
                  color: "#fff",
            ...
            <div className="flex gap-2 overflow-x-auto pb-2">
              {colors.map((colorOption) => (
                colorOption.href && colorOption.href !== "/fake-mac-os-x-update-screen" ? (
                  <I18nLink
                    ...
                    style={{
                      backgroundImage: colorOption.value === "mac-os-x" ? "url('/22/image/fake/mac-os-x-update-screen.webp')" :
                      ...
                      backgroundColor: colorOption.value === "mac-os-x" ? "#000" :
                  ...
                  <motion.button
                    ...
                    className={`flex-shrink-0 w-16 h-16 rounded-lg border-2 transition-all duration-200 relative ${selectedColor === colorOption.value
                      ? "border-white shadow-lg"
                      : "border-gray-500/50 hover:shadow-md"
                      }`}
                    style={{
                      backgroundColor: "#000",
                      backgroundImage: "url('/22/image/fake/mac-os-x-update-screen.webp')",
                      backgroundSize: "cover",
                      backgroundPosition: "center",
                      backgroundRepeat: "no-repeat"
                    }}
          ...
          >
              ...
              {colors.map((colorOption) => (
                colorOption.href && colorOption.href !== "/fake-mac-os-x-update-screen" ? (
                  <I18nLink
                    key={colorOption.value}
                    href={colorOption.href}
                    className="p-3 rounded-lg transition-all duration-200 hover:shadow-md cursor-pointer block bg-white/5 hover:bg-white/10 border border-gray-600/30"
                    title={`Go to ${colorOption.name} page`}
                  >
                    <div
                      className="w-full h-12 rounded-md border border-gray-500/30 relative mb-2"
                      style={{
                        backgroundImage: colorOption.value === "mac-os-x" ? "url('/22/image/fake/mac-os-x-update-screen.webp')" :
                          colorOption.value === "windows-10" ? "url('/22/image/fake/windows-10-update-screen.webp')" :
                            colorOption.value === "windows-xp" ? "url('/22/image/fake/windows-xp-update-screen.webp')" :
            ...
            <p className="text-sm text-gray-600">
              Perfect for pranks, system testing, and macOS update simulation
            </p>
        ...
        >
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span>Launch Mac OS X Update</span>
            </div>
          </motion.button>
