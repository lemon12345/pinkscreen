...
import ZoomLightingTemperatureControl from "./ZoomLightingTemperatureControl";

interface ZoomLightingHeroProps {
...
const COLORS_BACKGROUND = ["#FFE5B4", "#FFDAB9", "#FFE4B5", "#FFD700"];

export default function ZoomLightingHero({
  selectedColor,
  onColorChange,
  onFullscreen,
  onDownload,
  ...
  return (
    <motion.section
      className="relative grid place-content-center overflow-hidden py-16 md:py-28 2xl:py-40 bg-gradient-to-br from-yellow-50 via-amber-50 to-orange-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950"
    >
      {/* Background decorative elements */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-20 w-32 h-32 bg-yellow-400/30 dark:bg-yellow-300/40 rounded-full blur-3xl animate-pulse" />
        <div className="absolute top-40 right-20 w-40 h-40 bg-orange-400/30 dark:bg-orange-300/40 rounded-full blur-3xl animate-bounce" />
        <div className="absolute bottom-20 left-1/3 w-28 h-28 bg-amber-400/30 dark:bg-amber-300/40 rounded-full blur-2xl animate-pulse delay-1000" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center px-4">
        ...
        >
          <motion.span
            className="inline-flex items-center gap-2 rounded-full bg-yellow-600/50 dark:bg-yellow-400/30 px-3 py-1.5 text-sm text-yellow-100 dark:text-yellow-50"
        ...
        >
          {/* Left Column - Preview and Temperature Control */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            >
              <ZoomLightingTemperatureControl onTemperatureChange={onTemperatureChange} />
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-5 gap-3">
              {colors.map((colorOption) => (
                colorOption.href && colorOption.href !== "/zoom-lighting" ? (
                  <I18nLink
