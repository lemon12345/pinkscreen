...
export default function RedScreenUseCases() {
  ...
  const useCases = [
    ...
    {
      icon: "📖",
      title: t("useCases.cases.8.title"),
      description: t("useCases.cases.8.description")
    },
    {
      icon: "🔧",
      title: t("useCases.cases.9.title"),
      description: t("useCases.cases.9.description")
    }
  ];
