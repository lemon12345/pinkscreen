...
const COLORS_BACKGROUND = ["#FFC0CB", "#FFB6C1", "#FF69B4", "#FF1493"];

export default function PinkScreenHero({
  selectedColor,
  onColorChange,
  onFullscreen,
  onDownload,
  ...
  const backgroundImage = useMotionTemplate`radial-gradient(125% 125% at 50% 0%, #fdf2f8 0%, #fce7f3 50%, #fbcfe8 100%)`;
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-20 w-32 h-32 bg-pink-400/30 rounded-full blur-3xl animate-pulse" />
        <div className="absolute top-40 right-20 w-40 h-40 bg-purple-400/30 rounded-full blur-3xl animate-bounce" />
        <div className="absolute bottom-20 left-1/3 w-28 h-28 bg-blue-400/30 rounded-full blur-2xl animate-pulse delay-1000" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center px-4">
        ...
        >
          <motion.span
            className="inline-flex items-center gap-2 rounded-full bg-pink-600/50 px-3 py-1.5 text-sm text-pink-100"
        ...
        <motion.h1
          ...
          className="max-w-4xl bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 dark:from-white dark:via-blue-200 dark:to-purple-200 bg-clip-text text-center text-3xl font-medium leading-tight text-transparent sm:text-5xl sm:leading-tight md:text-7xl md:leading-tight"
        >
          {t("hero.title")}
        </motion.h1>
        ...
        <motion.p
          ...
          className="mt-6 mb-12 max-w-3xl text-center text-base leading-relaxed md:text-lg md:leading-relaxed text-gray-800 dark:text-gray-200"
        >
          {t("hero.description")}
        </motion.p>
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{t("interface.livePreview")}</h3>
            </div>
...
{t("interface.current")}: {selectedColor}
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{t("interface.chooseYourColor")}</h3>
            </div>
